    ...
    public function login_info($withlinks = null) {
        ...
        if (session_is_loggedinas()) {
            ...
            if ($withlinks) {
                ...
                $realuserinfo = ' [' . html_writer::link($realuserurl, $fullname,
                    array('class' => 'loggedinas', 'title' => $loginastitle)) . '] ';
            } else {
        ...
        if (empty($course->id)) {
            ...
            if ($withlinks) {
                ...
                $username = html_writer::link($usernameurl, $fullname, array('class' => 'username', 'title' => $linktitle));
            } else {
                $username = $fullname;
            }
