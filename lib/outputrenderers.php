    ...
    public function login_info($withlinks = null) {
        ...
        if (session_is_loggedinas()) {
            ...
            if ($withlinks) {
                ...
                $realuserurl  = new moodle_url('/course/loginas.php', array('id' => $course->id, 'sesskey' => sesskey(), 'title' => $loginastitle));
        ...
        if (empty($course->id)) {
            ...
            if ($withlinks) {
                ...
                $usernameurl = new moodle_url('/user/profile.php', array('id' => $USER->id, 'title' => $linktitle));
            ...
            if (is_mnet_remote_user($USER) and $idprovider = $DB->get_record('mnet_host', array('id'=>$USER->mnethostid))) {
                if ($withlinks) {
                    $providername = html_writer::link($idprovider->wwwroot, $idprovider->name, array('class' => 'idprovider'));
                } else {
                    $providername = $idprovider->name;
                }
                $username = get_string('from', 'mnet', $providername);
            }
            if (isguestuser()) {
